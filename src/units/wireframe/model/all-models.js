...
import { model as mainBanner } from './model.main-banner.js';
import { model as detailCard } from './model.detail-card.js';
...
export const model = {
   'wireframe-main:banner': mainBanner,
   'wireframe-detail:card': detailCard,
